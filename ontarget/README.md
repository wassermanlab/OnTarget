```
./gene2interval.py --lim-by-dist 100 -o ../data/examples/Adora2a/ Adora2a mm10 
./interval2regions.py --conservation --mask-exons --mask-repeats \
    ...
    --liftover hg19 --region-score 0.5546155574351114 \
    -o ../data/examples/Adora2a/ 10 75216876 75434792 mm10
./regions2minips.py --enzyme AscI --enzyme FseI --tf RARB --tf SP9 \
    -o ../data/examples/Adora2a/ ../data/examples/Adora2a/regions.json

./gene2interval.py --lim-by-dist 50 -o ../data/examples/Pitx3/ Pitx3 mm10 
./interval2regions.py --conservation --mask-exons --mask-repeats \
    ...
    --liftover hg19 --region-score 0.41415827439529823 \
    -o ./Pitx3/ 19 46085684 46198325 mm10
